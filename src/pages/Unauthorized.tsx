...
const Unauthorized = () => {
  return (
    <div className="min-h-screen px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8 bg-secondary-50">
        ...
        <main className="sm:flex">
          ...
          <div className="sm:ml-6">
            <div className="sm:border-l sm:border-secondary-200 sm:pl-6">
              ...
              <p className="mt-1 text-base text-secondary-500">
